package com.ducbao.common.model.builder;
...
public class ResponseBuilder {
    ...
    public static <T> ResponseEntity<ResponseDto<T>> okResponse(String message, @Nonnull T body, MetaData metaData, StatusCodeEnum statusCode) {
    ...
    @Nonnull
    public static <T> ResponseEntity<ResponseDto<T>> okResponse(@Nonnull T body, StatusCodeEnum statusCode, MetaData metaData) {
        final ResponseDto<T> dto = ResponseDto.<T>
                        builder()
                .success(true)
                .data(body)
